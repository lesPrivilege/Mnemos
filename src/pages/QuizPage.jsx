      ...
      <main className="page-scroll p-[18px] flex flex-col gap-3">
        ...
        <div className="qa-card">
          <span className="corner">
            ...
            <span><span className="font-zh">{S.quizPage.choiceLabel}</span>{isMultiAnswer(currentQuestion) && <span style={{ marginLeft: 6, fontSize: 10, background: 'var(--accent-soft)', color: 'var(--accent)', padding: '1px 5px', borderRadius: 4 }}>{S.quizPage.multiAnswerBadge}</span>}</span>
          </span>
